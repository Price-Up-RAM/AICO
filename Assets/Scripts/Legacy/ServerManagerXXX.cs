...
public class ServerManagerXXX : MonoBehaviour 
{
    private bool isConnected = false;

    // 싱글톤 인스턴스
    private static ServerManagerXXX instance;

    // 싱글톤 인스턴스에 접근하는 속성
    public static ServerManagerXXX Instance
    {
        get
        {
            if (instance == null)
            {
                instance = FindObjectOfType<ServerManagerXXX>();
            }
            return instance;
        }
    }
