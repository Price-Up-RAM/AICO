...
namespace Cleverous.VaultDashboard 
{
    public class VaultColumnOfAssets : VaultDashboardColumn
    {
        ...
        public void Pick(DataEntity asset)
        {
            ...
            VaultDashboard.SetCurrentInspectorAsset(asset);
        }
        ...
        {
            List<object> objs = input as List<object> ?? input.ToList();
#else
        ...
        private void GetSelectionPersistence()
        {
            ...
            VaultDashboard.SetCurrentInspectorAsset(CurrentSelections[0]);
        }
        ...
        public void DeleteSelection()
        {
            ...
            VaultDashboard.SetCurrentInspectorAsset(null);
            StringBuilder sb = new StringBuilder();
