...
2. Portrait column
   ...
   - Affection container with `호감도 0/100` and `친밀`. (구 표기 — 이후 친밀도(affinity) 블록으로 교체됨, `Affinity_Plan.md` 6장 참조)
3. Information column
   ...
   - Affinity(친밀도) TMP dropdown and direct input field, initially inactive.
