...
public static class LanguageData
{
    public static readonly List<Dictionary<string, string>> Texts = new List<Dictionary<string, string>>
    {
        ...
        new Dictionary<string, string> { { "ko", "표시" }, { "jp", "表示" }, { "en", "Show" } },
        new Dictionary<string, string> { { "ko", "모드" }, { "jp", "モード" }, { "en", "Mode" } },
        new Dictionary<string, string> { { "ko", "지우기" }, { "jp", "クリア" }, { "en", "Clear" } },
        new Dictionary<string, string> { { "ko", "사용 언어" }, { "jp", "使用言語" }, { "en", "Lang Used" } },
        new Dictionary<string, string> { { "ko", "API 키" }, { "jp", "APIキー" }, { "en", "API KEY" } },
        new Dictionary<string, string> { { "ko", "자동 잡담 : 30초" }, { "jp", "自動雑談 : 30秒" }, { "en", "Auto Small Talk : 30 sec" } },
        new Dictionary<string, string> { { "ko", "단축키" }, { "jp", "ホットキー" }, { "en", "HotKey" } },
        new Dictionary<string, string> { { "ko", "모델" }, { "jp", "モデル" }, { "en", "MODEL" } },
        new Dictionary<string, string> { { "ko", "모델" }, { "jp", "モデル" }, { "en", "Model" } },
        new Dictionary<string, string> { { "ko", "타입" }, { "jp", "タイプ" }, { "en", "Type" } },
        new Dictionary<string, string> { { "ko", "시간" }, { "jp", "時間" }, { "en", "Time" } },
        new Dictionary<string, string> { { "ko", "오퍼레이터" }, { "jp", "オペレーター" }, { "en", "Operator" } },
        new Dictionary<string, string> { { "ko", "API 테스트" }, { "jp", "APIテスト" }, { "en", "API Test" } },
        new Dictionary<string, string> { { "ko", "서버 확인" }, { "jp", "サーバー確認" }, { "en", "Check Server" } },
        new Dictionary<string, string> { { "ko", "전체화면" }, { "jp", "全画面" }, { "en", "Fullscreen" } },
        new Dictionary<string, string> { { "ko", "좌클릭 시 서버 시작 확인" }, { "jp", "左クリック時にサーバー起動を確認" }, { "en", "Ask to start server on left-click" } },
        new Dictionary<string, string> { { "ko", "기본 영역" }, { "jp", "デフォルト範囲" }, { "en", "Default Range" } },
        new Dictionary<string, string> { { "ko", "대화" }, { "jp", "会話" }, { "en", "Conversation" } },
        new Dictionary<string, string> { { "ko", "추론 언어" }, { "jp", "思考言語" }, { "en", "Think Language" } },
        new Dictionary<string, string> { { "ko", "원본" }, { "jp", "変換元" }, { "en", "From" } },
        new Dictionary<string, string> { { "ko", "의도" }, { "jp", "意図" }, { "en", "Intent" } },
        new Dictionary<string, string> { { "ko", "추천" }, { "jp", "おすすめ" }, { "en", "Recommend" } },
        new Dictionary<string, string> { { "ko", "재시작" }, { "jp", "再起動" }, { "en", "Reload" } },
        new Dictionary<string, string> { { "ko", "성공" }, { "jp", "成功" }, { "en", "Success" } },
        new Dictionary<string, string> { { "ko", "키 테스트" }, { "jp", "キーテスト" }, { "en", "Key Test" } },
        new Dictionary<string, string> { { "ko", "닫기" }, { "jp", "閉じる" }, { "en", "Close" } },
        new Dictionary<string, string> { { "ko", "중간" }, { "jp", "中" }, { "en", "Medium" } },
        new Dictionary<string, string> { { "ko", "선택지 추천" }, { "jp", "選択肢を推薦" }, { "en", "Recommend Choice" } },
        new Dictionary<string, string> { { "ko", "클릭 결과(실험)" }, { "jp", "クリック結果(実験)" }, { "en", "Click Result(Experiment)" } },
        new Dictionary<string, string> { { "ko", "대상" }, { "jp", "変換先" }, { "en", "To" } },
        new Dictionary<string, string> { { "ko", "의도 확인" }, { "jp", "意図確認" }, { "en", "Ask Intent" } },
        new Dictionary<string, string> { { "ko", "속도" }, { "jp", "速度" }, { "en", "Speed" } },
        new Dictionary<string, string> { { "ko", "블룸" }, { "jp", "ブルーム" }, { "en", "Bloom" } },
        new Dictionary<string, string> { { "ko", "자동 매핑" }, { "jp", "自動マッピング" }, { "en", "Auto Mapper" } },
        new Dictionary<string, string> { { "ko", "효과" }, { "jp", "エフェクト" }, { "en", "Effects" } },
        new Dictionary<string, string> { { "ko", "이미지 사용" }, { "jp", "画像を使用" }, { "en", "Use Image" } },
        new Dictionary<string, string> { { "ko", "플랫폼" }, { "jp", "プラットフォーム" }, { "en", "Platform" } },
        new Dictionary<string, string> { { "ko", "감정" }, { "jp", "感情" }, { "en", "Emotion" } },
        new Dictionary<string, string> { { "ko", "대상" }, { "jp", "対象" }, { "en", "Target" } },
        new Dictionary<string, string> { { "ko", "선택지 최소화" }, { "jp", "選択肢を最小化" }, { "en", "Minimize Choice" } },
        new Dictionary<string, string> { { "ko", "대화 정보" }, { "jp", "会話情報" }, { "en", "Dialogue Info" } },
        new Dictionary<string, string> { { "ko", "안티앨리어싱" }, { "jp", "アンチエイリアス" }, { "en", "Antialiasing" } },
        new Dictionary<string, string> { { "ko", "비네트" }, { "jp", "ビネット" }, { "en", "Vignette" } },
        new Dictionary<string, string> { { "ko", "해상도" }, { "jp", "解像度" }, { "en", "Resolution" } },
        new Dictionary<string, string> { { "ko", "높음" }, { "jp", "高" }, { "en", "High" } },
        new Dictionary<string, string> { { "ko", "일반" }, { "jp", "一般" }, { "en", "General" } },
        new Dictionary<string, string> { { "ko", "그래픽" }, { "jp", "グラフィック" }, { "en", "Graphics" } },
        new Dictionary<string, string> { { "ko", "번역기" }, { "jp", "翻訳機" }, { "en", "Translator" } },
        new Dictionary<string, string> { { "ko", "사운드" }, { "jp", "サウンド" }, { "en", "Sound" } },
        new Dictionary<string, string> { { "ko", "AI 모델" }, { "jp", "AIモデル" }, { "en", "AI Model" } },
        new Dictionary<string, string> { { "ko", "AI 정보" }, { "jp", "AI情報" }, { "en", "AI Info" } },
        new Dictionary<string, string> { { "ko", "에디션" }, { "jp", "エディション" }, { "en", "Edition" } },
        new Dictionary<string, string> { { "ko", "낮음" }, { "jp", "低" }, { "en", "Low" } },
        new Dictionary<string, string> { { "ko", "사용자 지정 영역" }, { "jp", "カスタム範囲" }, { "en", "Custom Range" } },
        new Dictionary<string, string> { { "ko", "이동성" }, { "jp", "機動性" }, { "en", "Mobility" } },
        new Dictionary<string, string> { { "ko", "옵션1" }, { "jp", "オプション1" }, { "en", "Option1" } },
        new Dictionary<string, string> { { "ko", "옵션2" }, { "jp", "オプション2" }, { "en", "Option2" } },
        new Dictionary<string, string> { { "ko", "옵션3" }, { "jp", "オプション3" }, { "en", "Option3" } },
        new Dictionary<string, string> { { "ko", "프롬프트" }, { "jp", "プロンプト" }, { "en", "Prompt" } },
        new Dictionary<string, string> { { "ko", "전역 단축키" }, { "jp", "グローバルホットキー" }, { "en", "Global Hotkey" } },
        new Dictionary<string, string> { { "ko", "크기" }, { "jp", "サイズ" }, { "en", "Size" } },
        new Dictionary<string, string> { { "ko", "AI 소스" }, { "jp", "AIソース" }, { "en", "AI Source" } },
        new Dictionary<string, string> { { "ko", "환경광" }, { "jp", "環境光" }, { "en", "Ambient" } },
        new Dictionary<string, string> { { "ko", "추론 모드" }, { "jp", "思考モード" }, { "en", "Think Mode" } },
        new Dictionary<string, string> { { "ko", "채팅 입력에서 STT 수정 (자동 전송 안 함)" }, { "jp", "チャット入力でSTTを編集 (自動送信なし)" }, { "en", "Edit STT in Chat Input (No Auto)" } },


        new Dictionary<string, string> { { "ko", "A.I." }, { "jp", "A.I." }, { "en", "A.I." } },
        new Dictionary<string, string> { { "ko", "기본값으로 복원" }, { "jp", "デフォルトに戻す" }, { "en", "Return to Default" } },
        new Dictionary<string, string> { { "ko", "울트라" }, { "jp", "ウルトラ" }, { "en", "Ultra" } },
        new Dictionary<string, string> { { "ko", "음성 필터" }, { "jp", "音声フィルター" }, { "en", "Voice Filter" } },
        ...
        new Dictionary<string, string> { { "ko", "코스튬 변경" }, { "jp", "コスチューム変更" }, { "en", "Change Costume" } },
        ...
        new Dictionary<string, string> { { "ko", "스크린샷 저장 및 보기" }, { "jp", "スクショを保存して表示" }, { "en", "Save and Show Screenshot" } },
        new Dictionary<string, string> { { "ko", "OCR" }, { "jp", "OCR" }, { "en", "OCR" } },
        ...
        new Dictionary<string, string> { { "ko", "할 일 목록" }, { "jp", "TODOリスト" }, { "en", "TODOList" } },
        ...
        new Dictionary<string, string> { { "ko", "호감도 +10" }, { "jp", "好感度 +10" }, { "en", "Affection +10" } },
        new Dictionary<string, string> { { "ko", "호감도 -10" }, { "jp", "好感度 -10" }, { "en", "Affection -10" } },
        new Dictionary<string, string> { { "ko", "오퍼레이터 모드" }, { "jp", "オペレーターモード" }, { "en", "OPERATOR MODE" } },
        ...
        // AIStatus UI
        new Dictionary<string, string> { { "ko", "AI 상태" }, { "jp", "AI状態" }, { "en", "AI Status" } },
        new Dictionary<string, string> { { "ko", "서버" }, { "jp", "サーバー" }, { "en", "Server" } },
        new Dictionary<string, string> { { "ko", "상태" }, { "jp", "状態" }, { "en", "Status" } },
        new Dictionary<string, string> { { "ko", "컨텍스트" }, { "jp", "コンテキスト" }, { "en", "Context" } },
        new Dictionary<string, string> { { "ko", "GPU" }, { "jp", "GPU" }, { "en", "GPU" } },
        new Dictionary<string, string> { { "ko", "시스템" }, { "jp", "システム" }, { "en", "System" } },
        new Dictionary<string, string> { { "ko", "벤치마크" }, { "jp", "ベンチマーク" }, { "en", "Benchmark" } },
        new Dictionary<string, string> { { "ko", "읽기 속도" }, { "jp", "読み取り速度" }, { "en", "Read Speed" } },
        new Dictionary<string, string> { { "ko", "생성 속도" }, { "jp", "生成速度" }, { "en", "Generation Speed" } },
        new Dictionary<string, string> { { "ko", "토큰/소요" }, { "jp", "トークン/所要" }, { "en", "Tokens/Time" } },
        new Dictionary<string, string> { { "ko", "분류" }, { "jp", "分類" }, { "en", "Category" } },
        new Dictionary<string, string> { { "ko", "리로드" }, { "jp", "リロード" }, { "en", "Reload" } },
        new Dictionary<string, string> { { "ko", "다운로드" }, { "jp", "ダウンロード" }, { "en", "Download" } },
        new Dictionary<string, string> { { "ko", "토큰테스트" }, { "jp", "トークンテスト" }, { "en", "Token Test" } },
        new Dictionary<string, string> { { "ko", "조회 중" }, { "jp", "照会中" }, { "en", "Checking" } },
        new Dictionary<string, string> { { "ko", "조회 중..." }, { "jp", "照会中..." }, { "en", "Checking..." } },
        new Dictionary<string, string> { { "ko", "로드 모델 없음" }, { "jp", "ロード済みモデルなし" }, { "en", "No loaded model" } },
        new Dictionary<string, string> { { "ko", "서버 미연결" }, { "jp", "サーバー未接続" }, { "en", "Server offline" } },
        new Dictionary<string, string> { { "ko", "다운로드할 모델 선택 없음" }, { "jp", "ダウンロードするモデルが選択されていません" }, { "en", "No model selected to download" } },
        new Dictionary<string, string> { { "ko", "다운로드 요청" }, { "jp", "ダウンロード要求" }, { "en", "Download requested" } },
        new Dictionary<string, string> { { "ko", "로딩 중" }, { "jp", "ロード中" }, { "en", "Loading" } },
        new Dictionary<string, string> { { "ko", "토큰 테스트 중" }, { "jp", "トークンテスト中" }, { "en", "Token testing" } },
        new Dictionary<string, string> { { "ko", "테스트 실패" }, { "jp", "テスト失敗" }, { "en", "Test failed" } },
        new Dictionary<string, string> { { "ko", "측정값 없음(서버 미로드?)" }, { "jp", "測定値なし(サーバー未ロード?)" }, { "en", "No measurement (model not loaded?)" } },
        new Dictionary<string, string> { { "ko", "측정값 없음" }, { "jp", "測定値なし" }, { "en", "No measurement" } },
        new Dictionary<string, string> { { "ko", "로드 완료" }, { "jp", "ロード完了" }, { "en", "Loaded" } },
        new Dictionary<string, string> { { "ko", "로드 실패" }, { "jp", "ロード失敗" }, { "en", "Load failed" } },
        new Dictionary<string, string> { { "ko", "모델 다운로드 필요" }, { "jp", "モデルのダウンロードが必要です" }, { "en", "Model download required" } },
        new Dictionary<string, string> { { "ko", "서버:" }, { "jp", "サーバー:" }, { "en", "Server:" } },
        new Dictionary<string, string> { { "ko", "DownloadManager 없음" }, { "jp", "DownloadManagerなし" }, { "en", "DownloadManager missing" } },
        new Dictionary<string, string> { { "ko", "not loaded" }, { "jp", "未ロード" }, { "en", "not loaded" } },
        new Dictionary<string, string> { { "ko", "offline" }, { "jp", "オフライン" }, { "en", "offline" } },
        new Dictionary<string, string> { { "ko", "psutil 미설치" }, { "jp", "psutil未インストール" }, { "en", "psutil missing" } },
