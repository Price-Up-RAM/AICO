...
public static class MissionDatabase
{
    public static List<MissionInfo> Build()
    {
        return new List<MissionInfo>
        {
            ...
            One("OB0005", MissionTab.Onboarding, 1, R(100), "머리 쓰다듬어 보기", "Pat Aiko's head", "頭をなでてみる"),
            ...
            Tier("CV0002", MissionTab.Conversation, T(10, 30, 50), Rs(R(150), R(400), R(600)), "\"기쁨\" 감정이 담긴 답변 받기", "Get joyful replies", "「喜び」がこもった返答をもらう"),
            ...
            One("CV0006", MissionTab.Conversation, 1, R(200), "답변에 '바나나' 포함하기", "Get \"banana\" in a reply", "返答に「バナナ」を含める"),
            Tier("CV0007", MissionTab.Conversation, T(10, 50, 100), Rs(R(100), R(400), R(700)), "대화하기", "Talk with Aiko", "アイコと会話する"),
            ...
            Tier("CV0010", MissionTab.Conversation, T(5, 10), Rs(R(120), R(400)), "한 번의 대화에 '바나나' 포함하기", "Get \"banana\" N times in one conversation", "一度の会話で「バナナ」をN回出す"),

            // 교감 (AF)
            Inc("AF0001", MissionTab.Affection, 10, 0, R(100), "머리 쓰다듬기", "Pat Aiko's head", "頭をなでる"),
            One("AF0002", MissionTab.Affection, 6, R(300), "모든 감정 표현 보기", "See all emotional expressions", "全ての感情表現を見る"),
            One("AF0003", MissionTab.Affection, 5, R(120), "캐릭터 변경", "Change your character", "キャラクターを変更する"),
            Inc("AF0004", MissionTab.Affection, 2, 1, R(100), "친밀도 레벨업", "Level up affinity", "親密度をレベルアップする"),
            ...
            Tier("PR0003", MissionTab.Productivity, T(1, 5, 20), Rs(R(80), R(300), R(500)), "포모도로 완료하기", "Complete pomodoro sessions", "ポモドーロを完了する"),
            ...
            // 도전 (CH) — 누적·마일스톤·메타
            Tier("CH0001", MissionTab.Challenge, T(100, 1000, 5000), Rs(R(100), R(100), R(100)), "골드 모으기", "Accumulate gold", "ゴールドを貯める"),
            Tier("CH0002", MissionTab.Challenge, T(10, 25, 50), Rs(R(300), R(700), R(1600)), "미션 달성하기", "Clear missions", "ミッションを達成する", meta: true),
            One("CH0003", MissionTab.Challenge, 1, R(400), "'첫걸음' 미션 모두 달성", "Complete all Onboarding missions", "「はじめの一歩」を全て達成する", meta: true),
            One("CH0004", MissionTab.Challenge, 1, R(500), "'대화' 미션 모두 달성", "Complete all Conversation missions", "「会話」ミッションを全て達成する", meta: true),
            One("CH0005", MissionTab.Challenge, 1, R(500), "'교감' 미션 모두 달성", "Complete all Affection missions", "「ふれあい」ミッションを全て達成する", meta: true),
            One("CH0006", MissionTab.Challenge, 1, R(500), "'생활' 미션 모두 달성", "Complete all Productivity missions", "「生活」ミッションを全て達成する", meta: true),
            Tier("CH0007", MissionTab.Challenge, T(100, 1000, 5000), Rs(R(100), R(100), R(100)), "골드 소비하기", "Spend gold", "ゴールドを使う"),
        };
    }

    // ── 작성 헬퍼 (1줄 표기용) ────────────────────────────────────────────────
    private static MissionReward R(int gold) => new MissionReward(gold);
