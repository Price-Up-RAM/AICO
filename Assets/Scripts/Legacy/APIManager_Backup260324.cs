...
//     private void ProcessReply(JObject jsonObject, GameObject targetCharacter = null)
//     {
...
//             if (targetCharacter != null && targetCharacter != CharManager.Instance.GetCurrentCharacter())
//             {
//                 SubAnswerBalloonSimpleController subController = SubAnswerBalloonSimpleManager.Instance.GetOrCreateController(targetCharacter);
...
//                 string nickname = targetCharacter != null ? CharManager.Instance.GetNickname(targetCharacter) : null;
...
//     private async void ProcessReplyGeminiDirect(JObject jsonObject, GameObject targetCharacter = null)
//     {
...
//                 string nickname = targetCharacter != null ? CharManager.Instance.GetNickname(targetCharacter) : null;
//                 bool isSubCharacter = targetCharacter != null && targetCharacter != CharManager.Instance.GetCurrentCharacter();
...
//     // 최종 반환 완료 시 호출될 함수
//     private void OnFinalResponseReceived(GameObject targetCharacter = null)
//     {
//         // 최종 응답이 비어있는지 체크
...
//         if (targetCharacter != null && targetCharacter != CharManager.Instance.GetCurrentCharacter())
//         {
//             nickname = CharManager.Instance.GetNickname(targetCharacter);
...
//             MemoryManager.Instance.SaveConversationMemory("player", "user", query_trans, query_trans, query_trans, query_trans, nickname);
...
//         {
//             // 사용자 메시지 저장 (원본)
//             MemoryManager.Instance.SaveConversationMemory("player", "user", query_origin, query_origin, query_origin, query_origin, nickname);
...
//                                         }
//                                         ProcessReply(jsonObject, targetCharacter); // 각 JSON 응답을 처리
//                                     }
//                                 }
//                                 else
//                                 {
...
//                             OnFinalResponseReceived(targetCharacter); // 최종 반환 완료 시 함수 호출 (타겟 전달)
//                         }
//                         else
//                         {
//                             Debug.Log("Skipping OnFinalResponseReceived for system type (asking_intent/trigger)");
...
//             chatIdx: chatIdx,
//             onChunkReceived: (chunk) => ProcessReplyGeminiDirect(chunk, targetCharacter),
//             onComplete: () => OnFinalResponseReceived(targetCharacter)
//         );
//     }
